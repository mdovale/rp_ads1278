...
enum {
    ...
    ADS1278_OPCODE_START_LOCAL_LOG = 6,
    ADS1278_OPCODE_STOP_LOCAL_LOG = 7,
    ADS1278_OPCODE_SET_LOCAL_LOG_DURATION = 8,
    ADS1278_OPCODE_SET_LOCAL_LOG_FILENAME = 9,
    ADS1278_OPCODE_SET_DEMOD_ENABLE = 10
};
