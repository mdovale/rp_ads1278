...
enum {
    ...
    ADS1278_REG_DMA_BUF_STATUS = 0x60,
    ADS1278_REG_DMA_BUF_ACK = 0x64,
    ADS1278_REG_DMA_OVERWRITE_COUNT = 0x68
};
...
enum {
    ...
    ADS1278_DMA_STATUS_CONFIG_PENDING = 1u << 5,
    ADS1278_DMA_STATUS_OVERWRITE_PENDING = 1u << 6,
...
enum {
    ...
    ADS1278_DMA_IRQ_OVERWRITE = 1u << 3
};

enum {
    ADS1278_DMA_BUF_STATUS_BUF0_FULL = 1u << 0,
    ADS1278_DMA_BUF_STATUS_BUF1_FULL = 1u << 1,
    ADS1278_DMA_BUF_STATUS_ACTIVE_BUF = 1u << 2,
    ADS1278_DMA_BUF_STATUS_OVERWRITE_PENDING = 1u << 3,
    ADS1278_DMA_BUF_ACK_BUF0 = 1u << 0,
    ADS1278_DMA_BUF_ACK_BUF1 = 1u << 1
};
